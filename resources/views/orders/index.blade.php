                ...
                <div class="w-full space-y-4 text-white text-sm text-left">
                        ...
                        <div class="py-4">
                            <div class="flex gap-6">
                                <div class="shrink-0 overflow-hidden w-[64px] sm:w-[84px] h-[64px] sm:h-[84px] rounded-2xl">
                                    <img src="{{Vite::asset('/resources/images/products/1.jpg')}}" class="object-cover w-full h-full" alt="Заказ №3517">
                                </div>
                                <div class="grow py-2">
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between px-4 md:px-6 rounded-xl md:rounded-2xl bg-card">
                        <div class="py-4">
                            <div class="flex gap-6">
                                <div class="shrink-0 overflow-hidden w-[64px] sm:w-[84px] h-[64px] sm:h-[84px] rounded-2xl">
                                    <img src="{{Vite::asset('/resources/images/products/6.jpg')}}" class="object-cover w-full h-full" alt="Заказ №2499">
                                </div>
                                <div class="grow py-2">
                                    <div class="flex flex-col md:flex-row md:items-center gap-2">
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between px-4 md:px-6 rounded-xl md:rounded-2xl bg-card">
                        <div class="py-4">
                            <div class="flex gap-6">
                                <div class="shrink-0 overflow-hidden w-[64px] sm:w-[84px] h-[64px] sm:h-[84px] rounded-2xl">
                                    <img src="{{Vite::asset('/resources/images/products/9.jpg')}}" class="object-cover w-full h-full" alt="Заказ №1902">
                                </div>
                                <div class="grow py-2">
                                    <div class="flex flex-col md:flex-row md:items-center gap-2">
